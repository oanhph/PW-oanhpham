...
test.describe("POST - Add Tag success", async () => {
    let name1 = "tag Oanh Pham 01";
    let name2 = "tag Oanh Pham 02";
    let slug2 = "oanh-pham-02";
    ...
    test("@POST_TAG_002 & @POST_TAG_003: Tag - add tag success", async ({ page }) => {
        ...
        await test.step("Submit special tag", async () => {
